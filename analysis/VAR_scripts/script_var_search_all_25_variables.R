...
saveRDS(list(cv_size_2 = cv_size_2),
        file = "./data/examples/all_ury_models_25_variables_s2.rds")
...
saveRDS(list(cv_size_3 = cv_size_3),
             file = "./data/examples/all_ury_models_25_variables_s3.rds")
...
saveRDS(list(cv_size_4 = cv_size_4),
             file = "./data/examples/all_ury_models_25_variables_s4.rds")
...
saveRDS(list(cv_size_5 = cv_size_5),
             file = "./data/examples/all_ury_models_25_variables_s5.rds")
...
saveRDS(list(cv_size_2 = cv_size_2, cv_size_3 = cv_size_3, 
        ...
        file = "./data/examples/all_ury_models_25_variables.rds")
