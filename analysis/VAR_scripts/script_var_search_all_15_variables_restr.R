...
tic()
specs_size_4_r <- all_specifications(
  var_size = 4,
  all_variables = names_15,
  lag_choices = lag_choices, 
  use_info_lags = FALSE,
...
tic()
specs_size_5_r <- all_specifications(
  var_size = 5,
  all_variables = names_15,
  lag_choices = lag_choices, 
  use_info_lags = FALSE,
...
saveRDS(list(cv_size_2 = cv_size_2, cv_size_3 = cv_size_3, 
        ...
        file = "./data/examples/all_ury_models_15_variables_restr.rds")
