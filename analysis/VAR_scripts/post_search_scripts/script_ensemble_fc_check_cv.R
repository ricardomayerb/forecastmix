...
# to free some memory
rm(models_from_search_3, models_from_search_4, models_from_search_5)
...
cv_of_ensamble_list_20 <- cv_of_VAR_ensemble_by_row(var_data = var_data,
