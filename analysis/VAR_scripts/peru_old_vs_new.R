...
new_tbl <- readRDS("./analysis/VAR_output/edd_exercises/2018_exercise_2/Peru_s1234_t2.rds")
new_tbl <- new_tbl %>% 
...
# old_tbl <- readRDS("./analysis/VAR_output/edd_exercises/2018_exercise_2/from_older_version_code/Peru_by_step_12345_to_comp.rds")
old_tbl <- readRDS("./analysis/VAR_output/edd_exercises/2018_exercise_2/from_older_version_code/Peru_by_step_12345.rds")
