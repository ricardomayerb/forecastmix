...
# Search_step_3 <- list(size = 4, vbl_selection_type = "manually_prechosen_variables", manually_prechosen = list(c("copper_output"), c("imp_capital")),  lags = default_vec_lag)
# Search_step_4 <- list(size = 5, vbl_selection_type = "manually_prechosen_variables", manually_prechosen = list(c("copper_output" , "imp_capital"), c("imp_capital", "imp")), lags = default_vec_lag)
