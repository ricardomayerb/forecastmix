...
all_specs_objects_r <- readRDS("./data/examples/all_ury_models_15_variables_restr.rds")
all_specs_models_r <- all_specs_objects_r$all_passing_models_2345
all_specs_models_r_not_u <- all_specs_models_r %>% filter(!is_unrestricted)


all_specs_objects_u <- readRDS("./data/examples/all_ury_models_15_variables.rds")
all_specs_models_u <- all_specs_objects_u$all_passing_models_2345
