...
# specifications_1to20 <- specifications_all[1:20, ] 
...
print(specifications_n20, n = 20)

specifications_n20endo <- specifications_n20[-c(6, 9, 13, 18, 19), ]
specifications_n20oneexo <- specifications_n20[-c(9, 13, 18, 19), ]
specifications_n20twoexo <- specifications_n20[-c(13, 18, 19), ]
specifications_n20threeexo <- specifications_n20[-c(18, 19), ]

specifications_n20justrow19 <- specifications_n20[19, ]
...
```{r tscv, message=FALSE, warning=FALSE, results='hide'}
n_cv <- 10
fc_horizon <- 8
