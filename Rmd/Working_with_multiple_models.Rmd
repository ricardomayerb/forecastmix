...
# 1742
tic()
specifications_size_3_big_u <- all_specifications(
...
specifications_size_3_small_u <- specifications_size_3_big_u[1:17, ] 
specifications_size_3_medium_u <- specifications_size_3_big_u[1:170, ] 
...
ftmt_size_3_small_u <- fit_tests_models_table(specifications_size_3_small_u, var_data = var_data)
pm_size_3_small_u <- ftmt_size_3_small_u[["passing_models"]]
print(head(pm_size_3_small_u))

ftmt_size_3_medium_u <- fit_tests_models_table(specifications_size_3_medium_u, var_data = var_data)
pm_size_3_medium_u <- ftmt_size_3_medium_u[["passing_models"]]
...
```{r smallmidbig unrest}
specifications_size_3_17_u <- specifications_size_3_big_u[1:17, ] 
specifications_size_3_170_u <- specifications_size_3_big_u[1:170, ] 
specifications_size_3_1700_u <- specifications_size_3_big_u[1:1700, ]

tic()
f17 <- fit_tests_models_table(specifications_size_3_17_u, var_data = var_data)
t17 <- toc()

tic()
f170 <- fit_tests_models_table(specifications_size_3_170_u, var_data = var_data)
t170 <- toc()

tic()
f1700 <- fit_tests_models_table(specifications_size_3_1700_u, var_data = var_data)
t1700 <- toc()

t170_17 <- (t170$toc - t170$tic)/(t17$toc - t17$tic)
t1700_170 <- (t1700$toc - t1700$tic)/(t170$toc - t170$tic)
