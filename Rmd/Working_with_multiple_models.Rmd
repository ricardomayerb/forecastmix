...
# tic()
# t_100 <- time_fit_cv(var_data = var_data, target_level_ts =  na.omit(raw_data[,target_variable]))
# print(t_100)
# toc()


tic()
t_100_3 <- time_fit_cv(var_data = var_data, target_level_ts =  na.omit(raw_data[,target_variable]), reps = 3)
print(t_100)
toc()

```

examing timings and counts
