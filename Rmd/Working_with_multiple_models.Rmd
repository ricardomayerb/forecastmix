...
time_size_3 <- function(var_data = var_data, target_level_ts = this_target_ts,
                        ...
                        ratios_r1_4_5 = c(1.311826, 1.430633), 
                        ratios_r2_4_5 = c(1.677138, 2.019805), 
                        n_specs = NULL) {
...
```{r timing_50, cache=TRUE}

tic()
t_50_u <- time_fit_cv(var_data = var_data, target_level_ts = this_target_ts, 
                       reps = 1, tosample = 50)
toc()

# a
tic()
t_50_r165 <- time_fit_cv(var_data = var_data, target_level_ts = this_target_ts,
                          reps = 1, t_thresholds = 1.65, tosample = 50)
toc()


tic()
t_50_r165_r2 <- time_fit_cv(var_data = var_data, target_level_ts = this_target_ts,
                          reps = 1, t_thresholds = c(1.65, 2), tosample = 50) 
toc()
...
t_50_r165$ave_timing*2
t_100_r165$ave_timing

t_50_r165_r2$ave_timing*2
t_100_r165_r2$ave_timing
...
names15 <- c(colnames(var_data), letters[1:10]) 

specs_s3_fake_41 <- all_specifications(
 var_size = 3, all_variables = names41, lag_choices = c(3,4,5))
specs_s4_fake_41 <- all_specifications(
  var_size = 4, all_variables =  names41, lag_choices = c(3,4,5))
specs_s5_fake_41 <- all_specifications(
  var_size = 5, all_variables =  names41, lag_choices = c(3,4,5))

n_specs_fake_41 <- c(nrow(specs_s3_fake_41), nrow(specs_s4_fake_41), nrow(specs_s5_fake_41))

all_specs_timings_fake_41 <- t_100_u$ave_timing[5,]*n_specs_fake_41/100
all_specs_timings_165_fake_41 <- t_100_r165$ave_timing[5,]*n_specs_fake_41/100
all_specs_timings_165_2_fake_41 <- t_100_r165_r2$ave_timing[5,]*n_specs_fake_41/100
...
specs_s3_fake_15 <- all_specifications(
 var_size = 3, all_variables = names15, lag_choices = c(3,4,5))
specs_s4_fake_15 <- all_specifications(
  var_size = 4, all_variables =  names15, lag_choices = c(3,4,5))
specs_s5_fake_15 <- all_specifications(
  var_size = 5, all_variables =  names15, lag_choices = c(3,4,5))

n_specs_fake_15 <- c(nrow(specs_s3_fake_15), nrow(specs_s4_fake_15), nrow(specs_s5_fake_15))

all_specs_timings_fake_15 <- t_100_u$ave_timing[5,]*n_specs_fake_15/100
all_specs_timings_165_fake_15 <- t_100_r165$ave_timing[5,]*n_specs_fake_15/100
all_specs_timings_165_2_fake_15 <- t_100_r165_r2$ave_timing[5,]*n_specs_fake_15/100
sum_all_specs_timings_fake_15 <- sum(all_specs_timings_fake_15)
sum_all_specs_timings_165_fake_15 <- sum(all_specs_timings_165_fake_15)
sum_all_specs_timings_165_2_fake_15 <- sum(all_specs_timings_165_2_fake_15)
...
print(nrow(specs_s3_all_u_noinfolags_fake_15))
print(nrow(specs_s4_all_u_noinfolags_fake_15))
print(nrow(specs_s5_all_u_noinfolags_fake_15))

sum_all_specs_timings_fake_15
sum_all_specs_timings_fake_15/60
sum_all_specs_timings_fake_15/3600

sum_all_specs_timings_165_fake_15
sum_all_specs_timings_165_fake_15/60
sum_all_specs_timings_165_fake_15/3600


sum_all_specs_timings_165_2_fake_15
sum_all_specs_timings_165_2_fake_15/60
sum_all_specs_timings_165_2_fake_15/3600
