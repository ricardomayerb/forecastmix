...
country_data_ts <- get_raw_data_ts(id = "Peru", 
                                   data_path = "./data/excel/Peru.xlsx",
                                   general_variables_to_drop = c("year", "quarter", "hlookup", "rgdp_sa", "trim", 
                                                                 "month", "exist", "expec_demand") ,
...
saveRDS(data_ts, "./data/raw_VAR_data/raw_VAR_data_Peru.rds")
...
print(paste0("Stationary transformation for rgdp: ", rgdp_rec_level))
...
trend_recom <- c("serv", "pib_nonprimary", "pib_commerce", "tcr")
...
saveRDS(final_VAR_data_for_estimation, "./data/VAR_data_Peru.rds")
...
saveRDS(object = list(country_name = country, 
        ...
        file = "./data/target_transformation/target_transformation_Peru.rds")
