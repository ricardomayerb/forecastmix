...
# exp or exp__1 is causing problems
country_data_ts <- get_raw_data_ts(id = "Ecuador", 
                                   data_path = "./data/excel/Ecuador.xlsx",
                                   general_variables_to_drop = c("year", "quarter", "hlookup", "rgdp_sa", "trim", 
                                                                 "month", "exist", "confianza_con", "confianza_emp", 
                                                                 "m1", "rm", "exp__1"),
...
saveRDS(data_ts, "./data/raw_VAR_data/raw_VAR_data_Ecuador.rds")
...
saveRDS(final_VAR_data_for_estimation, "./data/VAR_data_Ecuador.rds")
