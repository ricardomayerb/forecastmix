...
country_data_ts <- get_raw_data_ts(id = "Chile", 
                                   data_path = "./data/excel/Chile_with_cli.xlsx",
                                   general_variables_to_drop = c("year", "quarter", "hlookup", "rgdp_sa", "trim", 
                                                                 "month", "exist", "imacec_nomin", "imacec_min", "ip_ine", 
                                                                 "vta_auto"),
...
saveRDS(data_ts, "./data/raw_VAR_data/raw_VAR_data_Chile_with_cli.rds")
...
trend_recom <- c("rpc", "ipec", "tcr", "vtas_superm")
...
saveRDS(final_VAR_data_for_estimation, "./data/VAR_data_Chile_with_cli.rds")
...
saveRDS(object = list(country_name = country, 
        ...
        file = "./data/target_transformation/target_transformation_Chile.rds")
