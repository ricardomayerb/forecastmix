...
# emae is causing NA's in the var estimation so it is dropped
country_data_ts <- get_raw_data_ts(id = "Argentina", 
                                   data_path = "./data/excel/Argentina.xlsx",
...
saveRDS(data_ts, "./data/raw_VAR_data/raw_VAR_data_Argentina.rds")
...
trend_recom <- c("ip", "vta_mall", "m1", "icc_nacional", "faena")
...
saveRDS(final_VAR_data_for_estimation, "./data/VAR_data_Argentina.rds")
...
saveRDS(object = list(country_name = country, 
        ...
        file = "./data/target_transformation/target_transformation_Argentina.rds")
