...
country_data_ts <- get_raw_data_ts(id = "Paraguay", 
                                   data_path = "./data/excel/Paraguay.xlsx",
...
saveRDS(data_ts, "./data/raw_VAR_data/raw_VAR_data_Paraguay.rds")
...
trend_recom <- c("vtas_super", "retail")
...
saveRDS(final_VAR_data_for_estimation, "./data/VAR_data_Paraguay.rds")

# We need to save the transformation done to rgdp. 
target_transformation  <- rgdp_rec_level
country <- id

saveRDS(object = list(country_name = country, 
                      target_transformation = target_transformation), 
        file = "./data/target_transformation/target_transformation_Paraguay.rds")